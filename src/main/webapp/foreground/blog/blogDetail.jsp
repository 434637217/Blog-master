	...
	<div>
		...
		<div class="blog_info">
				...
				<c:choose>
					...
					<c:otherwise>
						<c:forEach items="${keyWords }" var="keyword">
							&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/blog/search?q=${keyword }">${keyword }</a>&nbsp;
						</c:forEach>
					</c:otherwise>
				</c:choose>
			</div>
			<div style="float:right;">
				...
				』&nbsp;&nbsp; 博客类别：<a
					href="${pageContext.request.contextPath }/blog/blogByType/${blog.blogType.id}">${blog.blogType.typeName }</a>&nbsp;&nbsp;
		...
		<div style="line-height:3; background-color: #F8F8FF">
			<font style="color:#8B2323">作者：tanbo</font>
		</div>
